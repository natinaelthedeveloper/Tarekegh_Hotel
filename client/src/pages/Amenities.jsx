...
import { ShieldCheck, Crown, Users, Sparkles, Check } from 'lucide-react';
          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Bullet Highlights */}
                <div className="pt-4 border-t border-gray-800/80 space-y-1.5">
                  {pillar.highlights.map((point, pIdx) => (
                    <div key={pIdx} className="flex items-center gap-2 text-[11px] text-gray-300">
                      <Check className="w-3.5 h-3.5 text-[#C89D54] shrink-0" />
                      <span>{point}</span>
                    </div>
                  ))}
                </div>
